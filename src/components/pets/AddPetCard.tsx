...
const AddPetCard = () => {
  ...
  return (
    <button onClick={() => router.push('/pets/create')} className="group flex cursor-pointer flex-col items-center justify-center p-5 min-h-[140px] rounded-xl border-2 border-dashed border-slate-200 hover:border-blue-400 hover:bg-blue-50/30 transition-all text-center">
